...
INSERT INTO "new_AppSettings" ("autoplay", "borderRadius", "borderStyle", "buttonAnimation", "buttonText", "buttonTextColor", "cardBackgroundColor", "createdAt", "customFont", "displayLocation", "enableGradient", "enableShadow", "floatingBorderColor", "floatingBorderWidth", "floatingOverlayText", "floatingPlayerVisible", "floatingPosition", "floatingSize", "hideOnMobile", "id", "instagramToken", "itemsPerRow", "layoutType", "minimizeOnClose", "mobilePosition", "primaryColor", "productPriceColor", "productTextSize", "productTitleColor", "shop", "showProductDetails", "showRating", "showSaleBadge", "showViews", "startMuted", "updatedAt", "widgetAspectRatio", "widgetBackgroundColor", "widgetCornerRadius", "widgetGap", "widgetHeading", "widgetHeadingColor", "widgetLayout") SELECT "autoplay", "borderRadius", "borderStyle", "buttonAnimation", "buttonText", "buttonTextColor", "cardBackgroundColor", "createdAt", "customFont", "displayLocation", "enableGradient", "enableShadow", "floatingBorderColor", "floatingBorderWidth", "floatingOverlayText", "floatingPlayerVisible", "floatingPosition", "floatingSize", "hideOnMobile", "id", "instagramToken", "itemsPerRow", "layoutType", "minimizeOnClose", "mobilePosition", "primaryColor", "productPriceColor", "productTextSize", "productTitleColor", "shop", "showProductDetails", "showRating", "showSaleBadge", "showViews", "startMuted", "updatedAt", "widgetAspectRatio", "widgetBackgroundColor", "widgetCornerRadius", "widgetGap", "widgetHeading", "widgetHeadingColor", "widgetLayout" FROM "AppSettings";
