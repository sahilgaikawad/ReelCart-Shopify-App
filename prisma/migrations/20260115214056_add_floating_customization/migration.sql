...
INSERT INTO "new_AppSettings" ("autoplay", "borderRadius", "buttonText", "createdAt", "displayLocation", "enableGradient", "floatingPlayerVisible", "id", "instagramToken", "layoutType", "primaryColor", "shop", "showRating", "showViews", "updatedAt") SELECT "autoplay", "borderRadius", "buttonText", "createdAt", "displayLocation", "enableGradient", "floatingPlayerVisible", "id", "instagramToken", "layoutType", "primaryColor", "shop", "showRating", "showViews", "updatedAt" FROM "AppSettings";
